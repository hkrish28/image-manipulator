...
/**
 * A GUIView allows users to perform operations on an image and provides support for two images
 * to be displayed (image and a histogram). It provides methods to get inputs from users, be it
 * integer values or confirmation status.
 *
 */
public interface GUIView extends View {

  /**
   * This method is used to provide the implementation of the various features to the UI that can
   * be utilized as callbacks for its components.
