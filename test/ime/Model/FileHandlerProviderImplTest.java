...
/**
 * class to test file handler provider class.
 */
public class FileHandlerProviderImplTest {
  ...
  public void testGetFileHandlerForPPM() throws IOException {
    FileHandler fileHandler = fileHandlerProvider.getFileHandler("i.ppm");
  ...
  public void testGetFileHandlerForJPG() throws IOException {
    FileHandler fileHandler = fileHandlerProvider.getFileHandler("image2.jpg");
  ...
  public void testGetFileHandlerForPNG() throws IOException {
    FileHandler fileHandler = fileHandlerProvider.getFileHandler("image.png");
    assertTrue(fileHandler instanceof CommonFileHandler);
  }
  ...
  public void testFileWithNoExtension() throws IllegalArgumentException {
    //FileHandler fileHandler = fileHandlerProvider.getFileHandler("image");
    assertThrows(IllegalArgumentException.class, () -> fileHandlerProvider.getFileHandler("image"));
  }
