...
public class PpmFileHandlerTest {
  ...
  public void testLoadImagePng() throws IOException {
    float[][][] expected = {
        ...
        {{255, 255, 255}, {255, 255, 255}}};
    float[][][] pixels = fileHandler.loadImage("test/resources/i.ppm");
  ...
  public void testSaveImage() throws IOException {
    ...
    fileHandler.saveImage(image, "test/resources/i.ppm");
  }
  ...
  public void testSaveImageInvalidDirectory() throws IOException {
    ...
    assertThrows(IOException.class, () -> fileHandler.saveImage(image, "test/invalid/i.ppm"));
  }
}
